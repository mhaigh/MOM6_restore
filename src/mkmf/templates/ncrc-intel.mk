...
# removed -debug minimal from opt and debug and fflags test 
...
FFLAGS := -msse2 -fno-alias -auto -safe-cray-ptr -ftz -assume byterecl -i4 -r8 -nowarn  $(INCLUDE)
FFLAGS_OPT = -O3 -fp-model source
FFLAGS_DEBUG = -g -O0 -check -check noarg_temp_created -check nopointer -warn -warn noerrors -fpe0 -ftrapuv
FFLAGS_REPRO = -O2 -fp-model source
...
FFLAGS_TEST = -O3 -fp-model source
CFLAGS_TEST = -O2
...
ifneq ($(findstring netcdf-4.0.1,$(LOADEDMODULES)),)z
  LIBS += -lnetcdff -lnetcdf -lhdf5_hl -lhdf5 -lz
else
  LIBS += -L/apps/netcdf/4.3.3/lib -L/apps/hdf5/1.8.14/parallel/lib -lnetcdf -lnetcdff -lhdf5_hl -lhdf5
endif
